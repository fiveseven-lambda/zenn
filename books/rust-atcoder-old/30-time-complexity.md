...
AC や WA ， TLE といった表示の意味は[このページ](https://atcoder.jp/contests/abc085/glossary)に書いてあります．これを見ると， TLE は「問題で指定された実行時間以内にプログラムが終了しなかった」という意味だと分かります．今回の場合，問題文の上部に「実行時間制限: 2 sec 」と書いてあるので，提出したコードは 2 秒以内に終了しなかったということになります．よって，コードを書き換えてプログラムをもっと高速にしなければなりません．
